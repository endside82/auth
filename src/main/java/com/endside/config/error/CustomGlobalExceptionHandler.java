...
import com.endside.config.error.exception.NotFoundException;
...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> commonRestException(RestException ex, WebRequest request) {
        printRequestLog(request);
        return exceptionResponse(ex, HttpStatus.UNAUTHORIZED);
    }
